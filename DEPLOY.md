# Деплой LeadOS (живая ссылка)

> Технические имена пока старые: репозиторий `MASTEROCH/signalos`, env-переменные `SIGNALOS_*`
> (теперь есть и алиасы `LEADOS_*` — приоритетнее). Живой сервис: https://signalos-es52.onrender.com
...
4. (Опц.) В Environment добавь `LEADOS_PLATFORM_KEY` = твой Anthropic-ключ,
